...
alias apupdd='sudo apt update && sudo apt dist-upgrade'
alias apupg='sudo apt upgrade'
alias apupdg='sudo apt update && sudo apt upgrade'
...
compdef _apupd apupd='sudo apt update'
compdef _apupdd apupdd='sudo apt update && sudo apt dist-upgrade'
compdef _apug apug='sudo apt upgrade'
compdef _apupdg apupdg='sudo apt update && sudo apt upgrade'
